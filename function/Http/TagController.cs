...
namespace Function.Http
{
    public class TagController
    {
        ...
        public async Task<IActionResult> DeleteTagBinding([HttpTrigger(AuthorizationLevel.Anonymous, "delete", Route = "fnc/dsb/tags")] HttpRequestMessage req, ExecutionContext context)
        {
