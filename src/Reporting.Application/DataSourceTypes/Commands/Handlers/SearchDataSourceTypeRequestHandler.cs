...
{
    public class SearchDataSourceTypeRequestHandler : IRequestHandler<SearchDataSourceType, BaseSearchResponse<DataSourceTypeDto>>
    {
        private readonly IDataSourceTypeService _service;
        private readonly ISystemContext _systemContext;

        public SearchDataSourceTypeRequestHandler(ISystemContext systemContext, IDataSourceTypeService service)
        {
            _service = service;
            _systemContext = systemContext;
        }

        public async Task<BaseSearchResponse<DataSourceTypeDto>> Handle(SearchDataSourceType request, CancellationToken cancellationToken)
        {
