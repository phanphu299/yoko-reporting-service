...
{
    public class SearchStorageRequestHandler : IRequestHandler<SearchStorage, BaseSearchResponse<StorageDto>>
    {
        private readonly IStorageService _service;
        private readonly ISystemContext _systemContext;

        public SearchStorageRequestHandler(ISystemContext systemContext, IStorageService service)
        {
            _service = service;
            _systemContext = systemContext;
        }

        public async Task<BaseSearchResponse<StorageDto>> Handle(SearchStorage request, CancellationToken cancellationToken)
        {
