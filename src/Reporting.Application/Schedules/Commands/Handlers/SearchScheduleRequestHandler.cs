...
{
    public class SearchScheduleRequestHandler : IRequestHandler<SearchSchedule, BaseSearchResponse<ScheduleDto>>
    {
        private readonly IScheduleService _service;
        private readonly ISystemContext _systemContext;
        private readonly ITagService _tagService;

        public SearchScheduleRequestHandler(ISystemContext systemContext, IScheduleService service, ITagService tagService)
        {
            _service = service;
        ...
        public async Task<BaseSearchResponse<ScheduleDto>> Handle(SearchSchedule request, CancellationToken cancellationToken)
        {
            ...
            BaseSearchResponse<ScheduleDto> response = await _service.SearchAsync(request);
